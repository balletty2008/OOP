...
//Enemies: Small sewer rat, Giant Dragon
    let rat = {
...
async function gameLoop() {
    ...
    switch(response.value) {
        ...
        //Enemies to attack  
        case 'Attack':
            console.log('Which enemy you want to attack?');
            const actionAttack = [
            ...
            //If the attack hits, the “attack damage points” should be subtracted from target hitpoint value. 
            //If hitpoints go to zero or below, the target is destroyed.
